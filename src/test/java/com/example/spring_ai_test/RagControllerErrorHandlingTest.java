...
class RagControllerErrorHandlingTest {
    ...
    @Test
    void askMarkdownDirectoryPostReturnsBadRequestWhenMessageIsBlank() throws Exception {
    ...
    @Test
    void askMarkdownFilePostReturnsBadRequestWhenFileNameIsInvalid() throws Exception {
    ...
    @Test
    void askMarkdownDirectoryReturnsServiceUnavailableWhenAiServiceIsUnavailable() throws Exception {
